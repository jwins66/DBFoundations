...
-- 2022-11-20,JWinslow started Question #1 and #2 along with video
-- 2022-11-21,JWinslow 
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_JWinslow')
	 Begin 
	  Alter Database [Assignment06DB_JWinslow] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_JWinslow;
	 End
	Create Database Assignment06DB_JWinslow;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_JWinslow;
...
-- Basic Views for the following tables Categories, Products, Employees, Inventories
...
As
 ...
 From vInventories as I
  ...
  Inner Join vCategories as C
   On P.CategoryID = C.CategoryID
 Where I.ProductID in (Select ProductID From vProducts Where ProductName In ('Chai', 'Chang'))  -- Only line change different from Question 7
 Order By I.InventoryDate, C.CategoryName, P.ProductName, EmployeeName;
go
